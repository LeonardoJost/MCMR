### exploratory analyses for more restrictive outliers
...
#read data
dataset=CSV.read("dataset\\datasetGroupedRestrictiveOutliers.csv", DataFrame)
#inspect data
...
modelFormula=@formula(acc~nStimuliContrasts+typeContrasts+sexContrasts+
              ...
              (nStimuliContrasts*typeContrasts+blockNumeric|ID))
@elapsed fixedEffects55=fit(LinearMixedModel,modelFormula, dataset,REML=false)
#n*type
modelFormula=@formula(acc~nStimuliContrasts+typeContrasts+sexContrasts+
              blockNumeric+nStimuliContrasts&typeContrasts+
              (nStimuliContrasts*typeContrasts+blockNumeric|ID))
@elapsed fixedEffects56=fit(LinearMixedModel,modelFormula, dataset,REML=false)
#sex*type
modelFormula=@formula(acc~nStimuliContrasts+typeContrasts+sexContrasts+
              blockNumeric+typeContrasts&sexContrasts+
              (nStimuliContrasts*typeContrasts+blockNumeric|ID))
@elapsed fixedEffects57=fit(LinearMixedModel,modelFormula, dataset,REML=false)
#n*sex*type
modelFormula=@formula(acc~nStimuliContrasts+typeContrasts+sexContrasts+
              blockNumeric+nStimuliContrasts&typeContrasts&sexContrasts+
              (nStimuliContrasts*typeContrasts+blockNumeric|ID))
@elapsed fixedEffects58=fit(LinearMixedModel,modelFormula, dataset,REML=false)
#comparison
...
show(MixedModels.likelihoodratiotest(fixedEffects5,fixedEffects57))
show(MixedModels.likelihoodratiotest(fixedEffects5,fixedEffects58))
